window.templateExports = {
    ...
    render: (data) => {
        ...
        return `<div class="template-classic" style="font-family:'Georgia',serif; max-width:950px; margin:0 auto; background:#ffffff; padding:1.8rem; border:1px solid #e2e8f0; border-top:8px solid #1e3a5f; box-shadow:0 2px 8px rgba(0,0,0,0.02);">
            ...
            ${profile ? `<div class="cv-section" style="margin-bottom:1.5rem;"><h3 style="color:#1e3a5f; border-left:4px solid #1e3a5f; padding-left:0.8rem;">💼 Perfil profesional</h3><p>${window.escapeHtml(profile)}</p></div>` : ''}
            ...
            <div class="cv-section" style="margin-bottom:1.5rem;"><h3 style="color:#1e3a5f; border-left:4px solid #1e3a5f; padding-left:0.8rem;">🏆 Logros destacados</h3>${achievementsHtml}</div>
            <div class="cv-section" style="margin-bottom:1.5rem;"><h3 style="color:#1e3a5f; border-left:4px solid #1e3a5f; padding-left:0.8rem;">💻 Proyectos personales</h3>${projectsHtml}</div>
